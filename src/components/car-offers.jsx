                                    ...
                                    <Col xs={6} md={4} className="py-2" key={`offer_${key}`}>
                                        <div className="gallery-box p-2">
                                            ...
                                            <div className="gallery-content text-center">
                                                ...
                                                <p className="fs-5 fw-500 m-0 pt-1 pb-2 primary-color">
                                                    {model}
                                                </p>
                                                <p className="fs-6 fw-500 m-0 pb-3 text-success">
                                                    ₹{value.rental_price ? value.rental_price.toLocaleString('en-IN') : '0'} per day
                                                </p>
